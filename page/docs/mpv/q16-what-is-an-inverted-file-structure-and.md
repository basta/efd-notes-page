> **Source question (Q16):** What is an inverted-file structure and how is it used to perform retrieval with BoW? In which cases is it better to use an inverted file instead of directly storing the original BoW vectors? What are the factors affecting the memory requirements for performing retrieval on a dataset of images with BoW and an inverted-file? What are the factors affecting the memory requirements for performing retrieval on a dataset of images with BoW when an inverted-file is not used?
